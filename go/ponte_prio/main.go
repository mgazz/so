// ponte_sensounico_prio project main.go -- prioritÃ  di direzione ai veicoli da NORD
...
const MAXBUFF = 100
const MAXPROC = 10
const MAX = 3 // capacitÃ 
const N int = 0
const S int = 1

var done = make(chan bool)
var termina = make(chan bool)
var entrataN = make(chan int, MAXBUFF) // necessitÃ  di accodamento per prioritÃ 
var entrataS = make(chan int, MAXBUFF) // necessitÃ  di accodamento per prioritÃ 
